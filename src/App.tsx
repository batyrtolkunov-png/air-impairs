    ...
    <main className="game-page">
      {gameStarted && (
        <DungeonGame
          ...
          equippedPet={(selectedPet==='cat'&&petUnlockRegions>=1)||(selectedPet==='crocodile'&&petUnlockRegions>=2)||(selectedPet==='pug'&&petUnlockRegions>=3)||(selectedPet==='capybara'&&petUnlockRegions>=4)?selectedPet:(petUnlockRegions >= 4 ? 'capybara' : petUnlockRegions >= 3 ? 'pug' : petUnlockRegions >= 2 ? 'crocodile' : petUnlockRegions >= 1 ? 'cat' : null)}

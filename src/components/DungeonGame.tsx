...
function drawJungleTree(ctx:CanvasRenderingContext2D,x:number,y:number,tint:string){ctx.fillStyle='rgba(0,9,4,.45)';ctx.fillRect(x+1,y+53,65,10);ctx.fillStyle='#422b1c';ctx.fillRect(x+27,y+30,17,31);ctx.fillStyle='#79502d';ctx.fillRect(x+32,y+31,7,28);ctx.fillStyle='#0d2d1d';ctx.fillRect(x+4,y+14,58,38);ctx.fillRect(x+15,y+2,40,50);ctx.fillStyle=tint;ctx.fillRect(x+9,y+18,23,23);ctx.fillRect(x+35,y+11,24,27);ctx.fillRect(x+21,y+5,24,25);ctx.fillStyle='#4b9854';ctx.fillRect(x+15,y+17,10,7);ctx.fillRect(x+39,y+14,11,7);ctx.fillRect(x+27,y+8,8,6);ctx.fillStyle='#8ac663';ctx.fillRect(x+20,y+20,5,4);ctx.fillRect(x+46,y+19,5,4);}

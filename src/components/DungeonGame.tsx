...
function drawFinalBoss(ctx:CanvasRenderingContext2D,e:Enemy,now:number){const pulse=Math.sin(now/130)*3;ctx.fillStyle='rgba(0,0,0,.55)';ctx.beginPath();ctx.ellipse(64,112,52,12,0,0,Math.PI*2);ctx.fill();ctx.fillStyle=e.flash>0?'#fff':'#160d1d';ctx.beginPath();ctx.moveTo(22,108);ctx.lineTo(31,45);ctx.lineTo(48,24);ctx.lineTo(80,24);ctx.lineTo(98,46);ctx.lineTo(108,108);ctx.closePath();ctx.fill();ctx.fillStyle='#39134d';ctx.fillRect(38,45,52,56);ctx.fillStyle='#0c0910';ctx.fillRect(43,18,43,38);ctx.fillStyle='#8e2bd0';ctx.fillRect(49,34,11,7);ctx.fillRect(70,34,11,7);ctx.fillStyle='#ff554f';ctx.fillRect(52,36,5,3);ctx.fillRect(73,36,5,3);ctx.fillStyle='#22102c';ctx.beginPath();ctx.moveTo(45,21);ctx.lineTo(29,-5-pulse);ctx.lineTo(54,14);ctx.fill();ctx.beginPath();ctx.moveTo(82,21);ctx.lineTo(101,-5+pulse);ctx.lineTo(75,14);ctx.fill();ctx.strokeStyle='#b52fdf';ctx.lineWidth=5;ctx.beginPath();ctx.arc(64,63,48+pulse,Math.PI*.1,Math.PI*.9);ctx.stroke();ctx.fillStyle='#e359ff';ctx.fillRect(59,73,10,17);}

  ...
  useEffect(() => {
    ...
    const loop = (now: number) => {
      ...
      sandTornadoes.current = sandTornadoes.current.filter((tornado) => {
        ...
        const radius = tornado.style === 'voidSaw' ? 32 : tornado.style === 'bossSword' || tornado.style === 'voidSword' ? 14 : tornado.style === 'fallingSword' ? 18 : tornado.style === 'iceLarge' ? 25 : tornado.style === 'iceSpiritDrop' ? 16 : tornado.style === 'iceRing' ? 12 : tornado.style === 'iceShard' ? 13 : tornado.style === 'frogTongue' ? 8 : 22;
        const reusableHit=tornado.style==='voidSaw'||tornado.style==='bossSword'||tornado.style==='voidSword',canSawHit=!reusableHit||now>=(tornado.hitCooldownUntil??0);const hitFirst = canSawHit&&!waitingToFall && health > 0 && !tornado.hitPlayer1 && Math.hypot(p.x + 12 - tornado.x, p.y + 14 - tornado.y) < radius;

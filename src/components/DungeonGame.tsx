...
function drawSandTornado(ctx: CanvasRenderingContext2D, tornado: SandTornado, now: number) {
  if(tornado.style==='bossSword'||tornado.style==='voidSword'){if(now<(tornado.launchAt??0))return;ctx.save();ctx.translate(tornado.x,tornado.y);ctx.rotate(Math.atan2(tornado.vy,tornado.vx)+Math.PI/2);ctx.fillStyle=tornado.style==='voidSword'?'#6d2396':'#c8d2d8';ctx.beginPath();ctx.moveTo(0,-25);ctx.lineTo(7,11);ctx.lineTo(0,19);ctx.lineTo(-7,11);ctx.closePath();ctx.fill();ctx.fillStyle=tornado.style==='voidSword'?'#e294ff':'#f5ffff';ctx.fillRect(-2,-18,4,28);ctx.fillStyle='#d4b354';ctx.fillRect(-13,10,26,5);ctx.fillStyle='#56371f';ctx.fillRect(-4,15,8,13);ctx.restore();return;}
  if(tornado.style==='fallingSword'){ctx.save();ctx.translate(tornado.x,tornado.y);if(now<(tornado.impactAt??0)){ctx.fillStyle='rgba(110,35,150,.24)';ctx.beginPath();ctx.arc(0,0,18,0,Math.PI*2);ctx.fill();ctx.strokeStyle='#c65cff';ctx.lineWidth=3;ctx.stroke();ctx.fillStyle='#fff';ctx.fillRect(-1,-11,2,22);ctx.fillRect(-11,-1,22,2);}else{ctx.fillStyle='#6d2396';ctx.beginPath();ctx.moveTo(0,-42);ctx.lineTo(9,10);ctx.lineTo(0,23);ctx.lineTo(-9,10);ctx.closePath();ctx.fill();ctx.fillStyle='#e294ff';ctx.fillRect(-3,-33,6,38);ctx.fillStyle='#211526';ctx.fillRect(-16,10,32,7);ctx.fillStyle='#8d40b3';ctx.fillRect(-5,17,10,18);}ctx.restore();return;}

...
function drawKnightGuard(ctx:CanvasRenderingContext2D,e:Enemy,now:number,attacking:boolean){
  ...
  ctx.fillStyle='rgba(0,0,0,.32)';ctx.beginPath();ctx.ellipse(64,111,39,9,0,0,Math.PI*2);ctx.fill();ctx.fillStyle='#252c35';ctx.fillRect(40,22,49,43);ctx.fillStyle=e.flash>0?'#fff':'#aebdca';ctx.fillRect(44,19,41,39);ctx.fillRect(38,59,53,43);ctx.fillStyle='#dce7ec';ctx.fillRect(48,23,33,7);ctx.fillStyle='#202833';ctx.fillRect(48,36,33,8);ctx.fillStyle='#f2c15d';ctx.fillRect(54,38,6,4);ctx.fillRect(70,38,6,4);ctx.fillStyle='#8c263b';ctx.fillRect(59,7,12,18);ctx.fillRect(52,10,26,8);ctx.fillStyle='#6d7884';ctx.fillRect(27,62,13,37);ctx.fillRect(90,62,13,37);ctx.fillStyle='#843245';ctx.fillRect(43,70,43,27);ctx.fillStyle='#d4b354';ctx.fillRect(43,68,43,6);ctx.fillStyle='#343b46';ctx.fillRect(43,97+stride,18,14);ctx.fillRect(70,97-stride,18,14);
